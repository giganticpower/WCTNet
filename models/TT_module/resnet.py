...
from models.TT_module.eca_module import eca_layer, esa_layer
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        #     GConv(3, 4, 5, padding=2, stride=1, M=4, nScale=1, bias=False, expand=True),
        #     nn.BatchNorm2d(4 * 4),
        #     nn.ReLU(inplace=True),
        #     nn.MaxPool2d(2, 2),
        #
        #     GConv(4, 16, 5, padding=2, stride=1, M=4, nScale=2, bias=False),
        #     nn.BatchNorm2d(16 * 4),
        #     nn.ReLU(inplace=True),
        #     nn.MaxPool2d(2, 2),

            # GConv(8, 32, 5, padding=2, stride=1, M=4, nScale=3, bias=False),
            # nn.BatchNorm2d(32 * 4),
            # nn.ReLU(inplace=True),
            # nn.MaxPool2d(2, 2),
        # )
...
def eca_resnet18(k_size=[3,5,5,5], pretrained=False, **kwargs):
    ...
    """
    model = ResNet1(ECABasicBlock,[2, 2, 2, 2], k_size=k_size, **kwargs)
